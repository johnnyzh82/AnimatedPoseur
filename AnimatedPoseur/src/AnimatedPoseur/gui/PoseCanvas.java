...
public class PoseCanvas extends JPanel
{
    ...
    public void paintToImage(BufferedImage imageToPaintTo)
    {
        ...
        AnimatedPoseurPose pose = AnimatedPoseStateManager.getPose();
    ...
    private void renderShapes(Graphics2D g2, Rectangle2D.Double poseArea)
    {
        ...
        while (shapesIt.hasNext())
        {
            ...
            boolean isSelected = AnimatedPoseStateManager.isSelectedShape(shape);
    ...
    private void renderShapeInProgress(Graphics2D g2, Rectangle2D.Double poseArea)
    {
        AnimatedPoseur singleton = AnimatedPoseur.getPoseur();
        PoseurStateManager AnimatedPoseStateManager = singleton.getPoseStateManager();
        PoseurShape shapeInProgress = AnimatedPoseStateManager.getShapeInProgress();
