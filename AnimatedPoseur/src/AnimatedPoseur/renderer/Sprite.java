 ...
 * that each sprite has a SpriteStates, and that multiple sprites may
...
public class Sprite 
{
    // EACH SPRITE IS TIED TO A SET OF ART AND POSES VIA ITS SpriteStates
     ...
     * be tied to a constructed SpriteStates, and must always have an animation
     ...
     */    
    public void setAnimationState(String initAnimationState)
    {
