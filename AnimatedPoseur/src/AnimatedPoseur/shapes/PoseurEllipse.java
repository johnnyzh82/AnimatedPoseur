 ...
 * 
 * @author  Richard McKenna & Yunlong Zhang
...
public class PoseurEllipse extends PoseurShape
{
    ...
    // WE'LL BE STORING OUR EllIPSES GEOMETRY INFORMATION IN "Pose" COORDINATES,
                           ...
                           Rectangle2D.Double poseArea) 
    {
        ...
        {
            geometry.x = poseArea.width - geometry.width -getOutlineThickness().getLineWidth();
        }
        // CLAMP ON TOP
        if (geometry.y < 0)
        {
        ...
        {
            geometry.y = poseArea.height - geometry.height - getOutlineThickness().getLineWidth();
        }
    }
